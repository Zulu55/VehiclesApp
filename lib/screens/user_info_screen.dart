...
class _UserInfoScreenState extends State<UserInfoScreen> {
          ...
          ClipRRect(
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                onPressed: () => launch('tel://+${RegexHelper.removeBlankSpaces('${widget.user.countryCode}${widget.user.phoneNumber}')}'), 
              ),
            ),
          ),       
          SizedBox(width: 10,),
  ...
  void _sendMessage() async {
    final link = WhatsAppUnilink(
      phoneNumber: '+${RegexHelper.removeBlankSpaces('${widget.user.countryCode}${widget.user.phoneNumber}')}',
